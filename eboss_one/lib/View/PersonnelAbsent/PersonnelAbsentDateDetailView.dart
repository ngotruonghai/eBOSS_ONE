...
class PersonnelAbsentDateDetailView extends StatelessWidget {
  PersonnelAbsentDateDetailView(
      {super.key,required this.ListAbsentDetails,required this.RemovePersonnelAbsentDetails});

  late List<AbsentDetails> ListAbsentDetails;
  final Function RemovePersonnelAbsentDetails;
  int _Index = -1;

  void _onClickAddTask(BuildContext context,int Index,String absentID){
    RemovePersonnelAbsentDetails(Index,absentID);
      ...
      body: Padding(
        ...
        child:SizedBox(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: ListAbsentDetails.map((item) {
                _Index = _Index + 1;
                return Column(
                  children: [
                    Container(
                      ...
                      child: Padding(padding: EdgeInsets.symmetric(horizontal: 5,vertical: 5),
                        child:  Column(
                          ...
                          children: [
                            Text("Công việc trên tay:",style: TextStyle(
                                fontSize: 13,
                                fontFamily: 'Roboto',
                                color: Colors.grey),),
                            Text(item.workDescription,style: TextStyle(
                                fontSize: 13,
                                fontFamily: 'Roboto',
                                color: Colors.black),),
                            SizedBox(
                            ...
                            Text("Giải pháp xử lý:",style: TextStyle(
                                fontSize: 13,
                                fontFamily: 'Roboto',
                                color: Colors.grey),),
                            Text(item.workSolution,style: TextStyle(
                                fontSize: 13,
                                fontFamily: 'Roboto',
                                color: Colors.black),),
                            SizedBox(
                            ...
                            SizedBox(
                              ...
                              child: InkWell(
                                onTap: (){
                                  //_onClickAddTask(context,int.parse(item.absentID.toString()));
